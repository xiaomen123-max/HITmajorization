...
if __name__ == '__main__':
    ...
    parser.add_argument('--depth_d', type=int, default=3)

    parser.add_argument('--dim_in', type=int, default=64, help='Input dimension')
    ...
    parser.add_argument('--n_heads', type=int, default=4, help='Number of hops')
